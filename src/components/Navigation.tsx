...
const PatientNavigation = (props: NavigationProps) => {
  ...
  const segmentMap =
    props.role === "patient" ? patientSegmentMap : doctorSegmentMap;
      ...
      <div className="flex justify-between bg-white h-[85px]">
        ...
        <div>
          <Segmented<string>
            ...
            options={[
              {
                label: props.buttonNames[0],
                value: props.buttonNames[0],
                icon: props.buttonImages[0],
              },
              {
                label: props.buttonNames[1],
                value: props.buttonNames[1],
                icon: props.buttonImages[1],
              },
              {
                label: props.buttonNames[2],
                value: props.buttonNames[2],
                icon: props.buttonImages[2],
              },
            ]}
          />
        </div>
